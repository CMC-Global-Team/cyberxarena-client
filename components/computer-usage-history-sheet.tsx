        ...
        <div className="space-y-6">
          {loading ? (
            <div className="flex items-center justify-center py-12">
              <div className="text-muted-foreground text-lg">Đang tải thông tin...</div>
            </div>
          ) : usageStats ? (
            <>
              {/* Thống kê tổng quan */}
                  ...
                  {usageStats.recentSessions && usageStats.recentSessions.length > 0 ? (
                    <div className="space-y-4">
                      {usageStats.recentSessions.map((session, index) => (
                        <div key={session.sessionId} className="border-2 border-border rounded-xl p-4 hover:shadow-md transition-shadow">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div className="space-y-2">
                              <div className="flex items-center gap-2 text-sm">
                                ...
                                <span className="text-foreground font-bold">{formatDuration(session.durationHours)}</span>
                              </div>
                              <div className="flex items-center gap-2 text-sm">
