...
export function DiscountAnimations({ children, className }: DiscountAnimationsProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Animate discount cards
      gsap.fromTo(
        "[data-animate='discount-card']",
        {
          y: 30,
          opacity: 0,
          scale: 0.95
        },
        {
          ...
          ease: "power2.out",
          scrollTrigger: {
            trigger: "[data-animate='discount-card']",
            start: "top 85%",
            end: "bottom 15%",
            toggleActions: "play none none reverse"
          }
      ...
      gsap.fromTo(
        ...
        },
        {
          ...
          ease: "back.out(1.7)",
          scrollTrigger: {
            trigger: "[data-animate='percentage-badge']",
            start: "top 90%",
            end: "bottom 10%",
            toggleActions: "play none none reverse"
          }
...
export function useDiscountAnimation() {
