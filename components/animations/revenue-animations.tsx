...
interface RevenueAnimationsProps {
  children: React.ReactNode
  className?: string
}

export function RevenueAnimations({ children, className }: RevenueAnimationsProps) {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ...
        },
        {
          ...
          ease: "power2.out",
          scrollTrigger: {
            trigger: "[data-animate='chart-container']",
            start: "top 70%",
            end: "bottom 30%",
            toggleActions: "play none none reverse"
          }
...
export function useRevenueAnimation() {
